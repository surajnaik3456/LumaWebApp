...
Feature: Verify new user checkout functionality
  ...
  Scenario Outline: Verify new user is able to checkout or not
    ...
    Examples: 
      ...
      | Testers   | s        | Testers2278@yopmail.com | Test12345 | Test12345       | Ida Workout Parachute Pant |   29 | Black  | Teknotrait solutions Pvt. Ltd | Linwood Boulevard Kansas City Missouri | Missouri | Arizona | 12345 | United States |  9732123456 | Fixed    |
